...
;=======>[X2-Entero]
SGN_X2 db 0
NUM_X2 db 0,0,0,0,0,0,0,0,0
DEC_X2 db 0,0,0,0,0,0,0,0,0 
...
;=======>[AUTOVARb88f9f51ae654ced99337fe11fa3d375-Cadena]
AUTOVARb88f9f51ae654ced99337fe11fa3d375 DW 00
LONGUITUD_AUTOVARb88f9f51ae654ced99337fe11fa3d375 DW 0

;=======>[SIGNOT2-Decimal]
SGN_SIGNOT2 db 0
NUM_SIGNOT2 db 0,0,0,0,0,0,0,0,0
DEC_SIGNOT2 db 0,0,0,0,0,0,0,0,0 

;=======>[ENTEROST2-Decimal]
SGN_ENTEROST2 db 0
NUM_ENTEROST2 db 0,0,0,0,0,0,0,0,0
DEC_ENTEROST2 db 0,0,0,0,0,0,0,0,0 

;=======>[DECIMALEST2-Decimal]
SGN_DECIMALEST2 db 0
NUM_DECIMALEST2 db 0,0,0,0,0,0,0,0,0
DEC_DECIMALEST2 db 0,0,0,0,0,0,0,0,0 
...
LEA DX,SGN_X2
CALL USAR_N2  ;vamos a utilizar T_X2
CALL MULTIPLICA
LEA DX,SGN_SIGNOT1
...
LEA DX,SGN_SIGNOT1
CALL USAR_N1  ;vamos a utilizar T1
...
MOV [SI],DL
MOV DX,CADENA
MOV AUTOVARb88f9f51ae654ced99337fe11fa3d375,DX
MOV DX,AUTOVARb88f9f51ae654ced99337fe11fa3d375
CALL IMPRIME_CADENA
LEA DI,SGN_X3
...
MOV BX,AUTOVARb88f9f51ae654ced99337fe11fa3d375
CALL LIBERAR_CADENA
MOV AH,4CH
INT 21H
RET
